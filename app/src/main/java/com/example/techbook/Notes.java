...
import static com.example.techbook.DashBoardActivity.navigationView;
...
public class Notes extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        requireActivity().setTitle("Old Question");

        DashBoardActivity.navigationView.setCheckedItem(R.id.nav_notes);
