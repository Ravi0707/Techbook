...
public class Database {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                notesRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        map.put("Uploader", DashBoardActivity.currentUser.getUsername());
    ...
    public Task<Void> uploadQuestion(String question, String title) {
        ...
        file.put("Uploader", DashBoardActivity.currentUser.getUsername());
    ...
    public Task<Void> uploadAnswer(String question, String answer) {
        ...
        ans.put("Uploader", DashBoardActivity.currentUser.getUsername());
